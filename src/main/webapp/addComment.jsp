...
<div class="container">
    ...
    <form id="loginFrom" action="${pageContext.request.contextPath}/comment/release/${sessionScope.user}/${requestScope.id}" method="post" class="form-horizontal">
        <fieldset>
            <legend>
                <label>
            ...
            <div class="form-group" id="midDiv">
                ...
                <div class="col-md-5">
                    <input type="text" id="mid" name="title" class="form-control">
                </div>
